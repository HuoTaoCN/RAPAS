...
// .wrangler/tmp/bundle-wvYSkd/strip-cf-connecting-ip-header.js
...
// .wrangler/tmp/pages-3TVMki/functionsWorker-0.19635753766305097.mjs
...
var splitPath = /* @__PURE__ */ __name2((path2) => {
...
var extractGroupsFromPath = /* @__PURE__ */ __name2((path2) => {
  const groups = [];
...
var checkOptionalParameter = /* @__PURE__ */ __name2((path2) => {
...
var OpenAIError = /* @__PURE__ */ __name(class extends Error {
}, "OpenAIError");
__name2(OpenAIError, "OpenAIError");
var APIError = /* @__PURE__ */ __name(class extends OpenAIError {
...
var APIUserAbortError = /* @__PURE__ */ __name(class extends APIError {
  constructor({ message } = {}) {
    super(void 0, void 0, message || "Request was aborted.", void 0);
  }
}, "APIUserAbortError");
__name2(APIUserAbortError, "APIUserAbortError");
var APIConnectionError = /* @__PURE__ */ __name(class extends APIError {
...
var APIConnectionTimeoutError = /* @__PURE__ */ __name(class extends APIConnectionError {
  constructor({ message } = {}) {
    super({ message: message ?? "Request timed out." });
  }
}, "APIConnectionTimeoutError");
__name2(APIConnectionTimeoutError, "APIConnectionTimeoutError");
var BadRequestError = /* @__PURE__ */ __name(class extends APIError {
}, "BadRequestError");
__name2(BadRequestError, "BadRequestError");
var AuthenticationError = /* @__PURE__ */ __name(class extends APIError {
}, "AuthenticationError");
__name2(AuthenticationError, "AuthenticationError");
var PermissionDeniedError = /* @__PURE__ */ __name(class extends APIError {
}, "PermissionDeniedError");
__name2(PermissionDeniedError, "PermissionDeniedError");
var NotFoundError = /* @__PURE__ */ __name(class extends APIError {
}, "NotFoundError");
__name2(NotFoundError, "NotFoundError");
var ConflictError = /* @__PURE__ */ __name(class extends APIError {
}, "ConflictError");
__name2(ConflictError, "ConflictError");
var UnprocessableEntityError = /* @__PURE__ */ __name(class extends APIError {
}, "UnprocessableEntityError");
__name2(UnprocessableEntityError, "UnprocessableEntityError");
var RateLimitError = /* @__PURE__ */ __name(class extends APIError {
}, "RateLimitError");
__name2(RateLimitError, "RateLimitError");
var InternalServerError = /* @__PURE__ */ __name(class extends APIError {
}, "InternalServerError");
__name2(InternalServerError, "InternalServerError");
var LengthFinishReasonError = /* @__PURE__ */ __name(class extends OpenAIError {
  constructor() {
    super(`Could not parse response content as the length limit was reached`);
  }
}, "LengthFinishReasonError");
__name2(LengthFinishReasonError, "LengthFinishReasonError");
var ContentFilterFinishReasonError = /* @__PURE__ */ __name(class extends OpenAIError {
  constructor() {
    super(`Could not parse response content as the request was rejected by the content filter`);
  }
}, "ContentFilterFinishReasonError");
__name2(ContentFilterFinishReasonError, "ContentFilterFinishReasonError");
var InvalidWebhookSignatureError = /* @__PURE__ */ __name(class extends Error {
  constructor(message) {
    super(message);
  }
}, "InvalidWebhookSignatureError");
__name2(InvalidWebhookSignatureError, "InvalidWebhookSignatureError");
var OAuthError = /* @__PURE__ */ __name(class extends APIError {
...
__name2(OAuthError, "OAuthError");
var SubjectTokenProviderError = /* @__PURE__ */ __name(class extends OpenAIError {
...
__name2(SubjectTokenProviderError, "SubjectTokenProviderError");
...
function getBrowserInfo() {
  ...
  for (const { key, pattern } of browserPatterns) {
    const match3 = pattern.exec("Cloudflare-Workers");
    if (match3) {
...
var default_formatter = /* @__PURE__ */ __name2((v) => String(v), "default_formatter");
var formatters = {
  RFC1738: (v) => String(v).replace(/%20/g, "+"),
  RFC3986: default_formatter
};
var RFC1738 = "RFC1738";
var has = /* @__PURE__ */ __name2((obj, key) => (has = Object.hasOwn ?? Function.prototype.call.bind(Object.prototype.hasOwnProperty), has(obj, key)), "has");
...
var limit = 1024;
var encode = /* @__PURE__ */ __name2((str2, _defaultEncoder, charset, _kind, format) => {
  if (str2.length === 0) {
    return str2;
  }
  let string = str2;
...
var push_to_array = /* @__PURE__ */ __name2(function(arr, value_or_array) {
...
var LineDecoder = /* @__PURE__ */ __name(class {
  constructor() {
...
var _Stream_client;
var Stream = /* @__PURE__ */ __name(class {
...
var SSEDecoder = /* @__PURE__ */ __name(class {
  constructor() {
    this.event = null;
    this.data = [];
    this.chunks = [];
...
__name2(addRequestID, "addRequestID");
var _APIPromise_client;
var APIPromise = /* @__PURE__ */ __name(class extends Promise {
...
var AbstractPage = /* @__PURE__ */ __name(class {
...
var PagePromise = /* @__PURE__ */ __name(class extends APIPromise {
...
var Page = /* @__PURE__ */ __name(class extends AbstractPage {
  constructor(client, response, body, options) {
...
__name2(Page, "Page");
var CursorPage = /* @__PURE__ */ __name(class extends AbstractPage {
  constructor(client, response, body, options) {
    super(client, response, body, options);
    this.data = body.data || [];
...
var ConversationCursorPage = /* @__PURE__ */ __name(class extends AbstractPage {
  constructor(client, response, body, options) {
    super(client, response, body, options);
    this.data = body.data || [];
    this.has_more = body.has_more || false;
...
__name2(ConversationCursorPage, "ConversationCursorPage");
var SUBJECT_TOKEN_TYPES = {
  jwt: "urn:ietf:params:oauth:token-type:jwt",
  id: "urn:ietf:params:oauth:token-type:id_token"
};
var TOKEN_EXCHANGE_GRANT_TYPE = "urn:ietf:params:oauth:grant-type:token-exchange";
var WorkloadIdentityAuth = /* @__PURE__ */ __name(class {
...
__name2(WorkloadIdentityAuth, "WorkloadIdentityAuth");
...
var maybeMultipartFormRequestOptions = /* @__PURE__ */ __name2(async (opts, fetch2) => {
...
var isUploadable = /* @__PURE__ */ __name2((value) => typeof value === "object" && value !== null && (value instanceof Response || isAsyncIterable(value) || isNamedBlob(value)), "isUploadable");
var hasUploadableValue = /* @__PURE__ */ __name2((value) => {
...
var APIResource = /* @__PURE__ */ __name(class {
  constructor(client) {
    this._client = client;
  }
}, "APIResource");
...
var Messages = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(isChatCompletionFunctionTool, "isChatCompletionFunctionTool");
...
__name2(assertToolCallsAreChatCompletionFunctionToolCalls, "assertToolCallsAreChatCompletionFunctionToolCalls");
...
var isAssistantMessage = /* @__PURE__ */ __name2((message) => {
  return message?.role === "assistant";
}, "isAssistantMessage");
var isToolMessage = /* @__PURE__ */ __name2((message) => {
...
var EventStream = /* @__PURE__ */ __name(class {
  constructor() {
...
var AbstractChatCompletionRunner = /* @__PURE__ */ __name(class extends EventStream {
  constructor() {
    super(...arguments);
...
_AbstractChatCompletionRunner_instances = /* @__PURE__ */ new WeakSet(), _AbstractChatCompletionRunner_getFinalContent = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _AbstractChatCompletionRunner_getFinalContent2() {
...
}, "_AbstractChatCompletionRunner_getFinalMessage2"), "_AbstractChatCompletionRunner_getFinalMessage"), _AbstractChatCompletionRunner_getFinalFunctionToolCall = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _AbstractChatCompletionRunner_getFinalFunctionToolCall2() {
  ...
  return;
}, "_AbstractChatCompletionRunner_getFinalFunctionToolCall2"), "_AbstractChatCompletionRunner_getFinalFunctionToolCall"), _AbstractChatCompletionRunner_getFinalFunctionToolCallResult = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _AbstractChatCompletionRunner_getFinalFunctionToolCallResult2() {
  for (let i = this.messages.length - 1; i >= 0; i--) {
    const message = this.messages[i];
  ...
  return;
}, "_AbstractChatCompletionRunner_getFinalFunctionToolCallResult2"), "_AbstractChatCompletionRunner_getFinalFunctionToolCallResult"), _AbstractChatCompletionRunner_calculateTotalUsage = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _AbstractChatCompletionRunner_calculateTotalUsage2() {
  const total = {
    completion_tokens: 0,
    prompt_tokens: 0,
    total_tokens: 0
...
var ChatCompletionRunner = /* @__PURE__ */ __name(class extends AbstractChatCompletionRunner {
...
var PartialJSON = /* @__PURE__ */ __name(class extends Error {
}, "PartialJSON");
__name2(PartialJSON, "PartialJSON");
var MalformedJSON = /* @__PURE__ */ __name(class extends Error {
}, "MalformedJSON");
...
var _parseJSON = /* @__PURE__ */ __name2((jsonString, allow) => {
...
var partialParse = /* @__PURE__ */ __name2((input) => parseJSON(input, Allow.ALL ^ Allow.NUM), "partialParse");
...
var ChatCompletionStream = /* @__PURE__ */ __name(class extends AbstractChatCompletionRunner {
  constructor(params) {
    super();
...
var ChatCompletionStreamingRunner = /* @__PURE__ */ __name(class extends ChatCompletionStream {
  static fromReadableStream(stream) {
...
var Completions = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var Chat = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var Speech = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var Transcriptions = /* @__PURE__ */ __name(class extends APIResource {
  create(body, options) {
...
var Translations = /* @__PURE__ */ __name(class extends APIResource {
  create(body, options) {
    return this._client.post("/audio/translations", multipartFormRequestOptions({ body, ...options, __metadata: { model: body.model } }, this._client));
  }
}, "Translations");
__name2(Translations, "Translations");
var Audio = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
Audio.Speech = Speech;
var Batches = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var Assistants = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var Sessions = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Sessions, "Sessions");
var TranscriptionSessions = /* @__PURE__ */ __name(class extends APIResource {
  /**
   * Create an ephemeral API token for use in client-side applications with the
...
__name2(TranscriptionSessions, "TranscriptionSessions");
var Realtime = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Realtime, "Realtime");
Realtime.Sessions = Sessions;
Realtime.TranscriptionSessions = TranscriptionSessions;
var Sessions2 = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Sessions2, "Sessions");
var Threads = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var ChatKit = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(ChatKit, "ChatKit");
ChatKit.Sessions = Sessions2;
ChatKit.Threads = Threads;
var Messages2 = /* @__PURE__ */ __name(class extends APIResource {
  /**
   * Create a message.
   *
...
__name2(Messages2, "Messages");
var Steps = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Steps, "Steps");
var toFloat32Array = /* @__PURE__ */ __name2((base64Str) => {
...
var AssistantStream = /* @__PURE__ */ __name(class extends EventStream {
  constructor() {
    super(...arguments);
...
_a = AssistantStream, _AssistantStream_addEvent = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _AssistantStream_addEvent2(event) {
  if (this.ended)
    return;
...
var Runs = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Runs, "Runs");
Runs.Steps = Steps;
var Threads2 = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Threads2, "Threads");
Threads2.Runs = Runs;
Threads2.Messages = Messages2;
var Beta = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var Completions2 = /* @__PURE__ */ __name(class extends APIResource {
  create(body, options) {
    return this._client.post("/completions", { body, ...options, stream: body.stream ?? false });
  }
}, "Completions2");
__name2(Completions2, "Completions");
var Content = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Content, "Content");
var Files = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var Containers = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Containers, "Containers");
Containers.Files = Files;
var Items = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Items, "Items");
var Conversations = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Conversations, "Conversations");
Conversations.Items = Items;
var Embeddings = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var OutputItems = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(OutputItems, "OutputItems");
var Runs2 = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var Evals = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Evals, "Evals");
Evals.Runs = Runs2;
var Files2 = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var Methods = /* @__PURE__ */ __name(class extends APIResource {
}, "Methods");
__name2(Methods, "Methods");
var Graders = /* @__PURE__ */ __name(class extends APIResource {
  /**
   * Run a grader.
   *
   * @example
...
__name2(Graders, "Graders");
var Alpha = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var Permissions = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Permissions, "Permissions");
var Checkpoints = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var Checkpoints2 = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Checkpoints2, "Checkpoints");
var Jobs = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var FineTuning = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var GraderModels = /* @__PURE__ */ __name(class extends APIResource {
}, "GraderModels");
__name2(GraderModels, "GraderModels");
var Graders2 = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
    this.graderModels = new GraderModels(this._client);
  }
}, "Graders2");
__name2(Graders2, "Graders");
Graders2.GraderModels = GraderModels;
var Images = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var Models = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var Moderations = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var Calls = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Calls, "Calls");
var ClientSecrets = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(ClientSecrets, "ClientSecrets");
var Realtime2 = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var ResponseStream = /* @__PURE__ */ __name(class extends EventStream {
  constructor(params) {
    super();
...
__name2(ResponseStream, "ResponseStream");
function finalizeResponse(snapshot, params) {
  return maybeParseResponse(snapshot, params);
}
__name(finalizeResponse, "finalizeResponse");
__name2(finalizeResponse, "finalizeResponse");
var InputItems = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(InputItems, "InputItems");
var InputTokens = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(InputTokens, "InputTokens");
var Responses = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Responses, "Responses");
Responses.InputItems = InputItems;
Responses.InputTokens = InputTokens;
var Content2 = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Content2, "Content");
var Content3 = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Content3, "Content");
var Versions = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Versions, "Versions");
Versions.Content = Content3;
var Skills = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Skills, "Skills");
Skills.Content = Content2;
Skills.Versions = Versions;
var Parts = /* @__PURE__ */ __name(class extends APIResource {
  /**
   * Adds a
...
__name2(Parts, "Parts");
var Uploads = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
Uploads.Parts = Parts;
var allSettledWithThrow = /* @__PURE__ */ __name2(async (promises) => {
...
var FileBatches = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
var Files3 = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Files3, "Files");
var VectorStores = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
var Videos = /* @__PURE__ */ __name(class extends APIResource {
  /**
...
__name2(Videos, "Videos");
var _Webhooks_instances;
var _Webhooks_validateSecret;
var _Webhooks_getRequiredHeader;
var Webhooks = /* @__PURE__ */ __name(class extends APIResource {
  constructor() {
    super(...arguments);
...
__name2(Webhooks, "Webhooks");
_Webhooks_instances = /* @__PURE__ */ new WeakSet(), _Webhooks_validateSecret = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _Webhooks_validateSecret2(secret) {
  if (typeof secret !== "string" || secret.length === 0) {
    throw new Error(`The webhook secret must either be set using the env var, OPENAI_WEBHOOK_SECRET, on the client class, OpenAI({ webhookSecret: '123' }), or passed to this function`);
  }
}, "_Webhooks_validateSecret2"), "_Webhooks_validateSecret"), _Webhooks_getRequiredHeader = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _Webhooks_getRequiredHeader2(headers, name) {
  if (!headers) {
  ...
  return value;
}, "_Webhooks_getRequiredHeader2"), "_Webhooks_getRequiredHeader");
var _OpenAI_instances;
var _a2;
var _OpenAI_encoder;
var _OpenAI_baseURLOverridden;
var WORKLOAD_IDENTITY_API_KEY_PLACEHOLDER = "workload-identity-auth";
var OpenAI = /* @__PURE__ */ __name(class {
  /**
...
_a2 = OpenAI, _OpenAI_encoder = /* @__PURE__ */ new WeakMap(), _OpenAI_instances = /* @__PURE__ */ new WeakSet(), _OpenAI_baseURLOverridden = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _OpenAI_baseURLOverridden2() {
  return this.baseURL !== "https://api.openai.com/v1";
}, "_OpenAI_baseURLOverridden2"), "_OpenAI_baseURLOverridden");
OpenAI.OpenAI = _a2;
...
app.post("/analyze", async (c) => {
  try {
    ...
    let inputContext = "";
    const rawData = typeof input_data === "string" ? (() => {
      try {
...
// .wrangler/tmp/bundle-wvYSkd/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-wvYSkd/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.19635753766305097.js.map
